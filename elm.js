...
Elm.Async = Elm.Async || {};
Elm.Async.make = function (_elm) {
   "use strict";
   _elm.Async = _elm.Async || {};
   if (_elm.Async.values) return _elm.Async.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   var Requested = {ctor: "Requested"};
   var NotRequested = {ctor: "NotRequested"};
   return _elm.Async.values = {_op: _op
                              ,NotRequested: NotRequested
                              ,Requested: Requested
                              ,Finished: Finished
                              ,Error: Error};
};
Elm.DecodeExt = Elm.DecodeExt || {};
Elm.DecodeExt.make = function (_elm) {
   "use strict";
   _elm.DecodeExt = _elm.DecodeExt || {};
   if (_elm.DecodeExt.values) return _elm.DecodeExt.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Json$Decode = Elm.Json.Decode.make(_elm),
   ...
   return _elm.DecodeExt.values = {_op: _op,nullOr: nullOr};
};
Elm.HttpExt = Elm.HttpExt || {};
Elm.HttpExt.make = function (_elm) {
   "use strict";
   _elm.HttpExt = _elm.HttpExt || {};
   if (_elm.HttpExt.values) return _elm.HttpExt.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   ...
   $Task = Elm.Task.make(_elm);
   var _op = {};
   var fetch = F3(function (decoder,url,action) {
      return $Effects.task(A2($Task.map,
      action,
      $Task.toResult(A2($Http.get,decoder,url))));
   });
   return _elm.HttpExt.values = {_op: _op,fetch: fetch};
};
Elm.ListExt = Elm.ListExt || {};
Elm.ListExt.make = function (_elm) {
   "use strict";
   _elm.ListExt = _elm.ListExt || {};
   if (_elm.ListExt.values) return _elm.ListExt.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   var split = F2(function (n,xs) {
      return _U.cmp($List.length(xs),n) > 0 ? A2($List._op["::"],
      A2($List.take,n,xs),
      A2(split,n,A2($List.drop,n,xs))) : _U.list([xs]);
   });
   return _elm.ListExt.values = {_op: _op,split: split};
};
Elm.NamedAPIResource = Elm.NamedAPIResource || {};
Elm.NamedAPIResource.make = function (_elm) {
   "use strict";
   _elm.NamedAPIResource = _elm.NamedAPIResource || {};
   if (_elm.NamedAPIResource.values)
   return _elm.NamedAPIResource.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Json$Decode = Elm.Json.Decode.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var NamedAPIResource = F2(function (a,b) {
      return {name: a,url: b};
   });
   ...
   return _elm.NamedAPIResource.values = {_op: _op
                                         ,NamedAPIResource: NamedAPIResource
                                         ,decoder: decoder};
};
Elm.NamedAPIResourceList = Elm.NamedAPIResourceList || {};
Elm.NamedAPIResourceList.make = function (_elm) {
   "use strict";
   _elm.NamedAPIResourceList = _elm.NamedAPIResourceList || {};
   if (_elm.NamedAPIResourceList.values)
   return _elm.NamedAPIResourceList.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $DecodeExt = Elm.DecodeExt.make(_elm),
   $Json$Decode = Elm.Json.Decode.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $NamedAPIResource = Elm.NamedAPIResource.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var empty = {count: 0
               ...
               ,results: _U.list([])};
   var NamedAPIResourceList = F4(function (a,b,c,d) {
   ...
   A2($Json$Decode._op[":="],
   "next",
   $DecodeExt.nullOr($Json$Decode.string)),
   A2($Json$Decode._op[":="],
   "previous",
   $DecodeExt.nullOr($Json$Decode.string)),
   A2($Json$Decode._op[":="],
   "results",
   $Json$Decode.list($NamedAPIResource.decoder)));
   return _elm.NamedAPIResourceList.values = {_op: _op
                                             ,NamedAPIResourceList: NamedAPIResourceList
                                             ,empty: empty
                                             ,decoder: decoder};
};
Elm.PokemonTable = Elm.PokemonTable || {};
Elm.PokemonTable.make = function (_elm) {
   "use strict";
   _elm.PokemonTable = _elm.PokemonTable || {};
   if (_elm.PokemonTable.values) return _elm.PokemonTable.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   ...
   $Maybe = Elm.Maybe.make(_elm),
   $NamedAPIResource = Elm.NamedAPIResource.make(_elm),
   $NamedAPIResourceList = Elm.NamedAPIResourceList.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $String = Elm.String.make(_elm);
   var _op = {};
   var isNotEmpty = function (list) {
      return $Basics.not($String.isEmpty(list));
   };
   var guessIdString = function (res) {
      return $List.head($List.reverse(A2($List.filter,
      isNotEmpty,
      A2($String.split,"/",res.url))));
   };
   ...
   var empty = $NamedAPIResourceList.empty;
   return _elm.PokemonTable.values = {_op: _op
                                     ,empty: empty
                                     ,listUrl: listUrl
                                     ,fetch: fetch
                                     ,viewWithSelect: viewWithSelect
                                     ,toLi: toLi
                                     ,imageFromId: imageFromId
                                     ,guessIdString: guessIdString
...
Elm.Type.make = function (_elm) {
   "use strict";
   _elm.Type = _elm.Type || {};
   if (_elm.Type.values) return _elm.Type.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Dict = Elm.Dict.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var updateDamageDict = F3(function (mult,resource,dict) {
      var update = function (dam) {
         var _p0 = dam;
         if (_p0.ctor === "Just") {
               return $Maybe.Just(_p0._0 * mult);
            } else {
               return $Maybe.Just(mult);
            }
      };
      return A3($Dict.update,resource.name,update,dict);
   });
   var damageRelationsToMultiplyers = function (relations) {
      var no = A3($List.foldr,
      updateDamageDict(0),
      $Dict.empty,
      relations.no_damage_from);
      var withHalf = A3($List.foldr,
      updateDamageDict(0.5),
      no,
      relations.half_damage_from);
      var withDouble = A3($List.foldr,
      updateDamageDict(2),
      withHalf,
      relations.double_damage_from);
      return withDouble;
   };
   var combineDamageRelationsOfTypes = function (types) {
      return {no_damage_from: A2($List.concatMap,
             function (t) {
                return t.damage_relations.no_damage_from;
             },
             types)
             ,half_damage_from: A2($List.concatMap,
             function (t) {
                return t.damage_relations.half_damage_from;
             },
             types)
             ,double_damage_from: A2($List.concatMap,
             function (t) {
                return t.damage_relations.double_damage_from;
             },
             types)};
   };
   var damageToLi = F2(function (typeName,dam) {
      return A2($Html.li,
      _U.list([$Html$Attributes.$class(typeName)]),
      _U.list([A2($Html.div,
              _U.list([]),
              _U.list([$Html.text(typeName)]))
              ,A2($Html.div,
              _U.list([]),
              _U.list([$Html.text($Basics.toString(dam))]))]));
   });
   var viewDamageRelations = function (dr) {
      var chart = damageRelationsToMultiplyers(dr);
      var withoutNeutral = A2($Dict.filter,
      F2(function (_p1,d) {    return !_U.eq(d,1);}),
      chart);
      var damageLis = A3($Dict.foldr,
      F3(function (t,d,l) {
         return A2($List._op["::"],A2(damageToLi,t,d),l);
      }),
      _U.list([]),
      withoutNeutral);
      return A2($Html.ul,
      _U.list([$Html$Attributes.$class("damageChart")]),
      damageLis);
   };
   var viewDamageRelationsOfList = function (types) {
      return viewDamageRelations(combineDamageRelationsOfTypes(types));
   };
   var DamageRelations = F3(function (a,b,c) {
      return {no_damage_from: a
             ,half_damage_from: b
             ,double_damage_from: c};
   });
   var typeRelationsDecoder = A4($Json$Decode.object3,
   DamageRelations,
   A2($Json$Decode._op[":="],
   "no_damage_from",
   $Json$Decode.list($NamedAPIResource.decoder)),
   ...
   "double_damage_from",
   $Json$Decode.list($NamedAPIResource.decoder)));
   var Type = F3(function (a,b,c) {
      return {id: a,name: b,damage_relations: c};
   });
   ...
   return _elm.Type.values = {_op: _op
                             ...
                             ,decoder: decoder
                             ,typeRelationsDecoder: typeRelationsDecoder
                             ,viewDamageRelationsOfList: viewDamageRelationsOfList
                             ,viewDamageRelations: viewDamageRelations
                             ,damageToLi: damageToLi
                             ,combineDamageRelationsOfTypes: combineDamageRelationsOfTypes
                             ,damageRelationsToMultiplyers: damageRelationsToMultiplyers
                             ,updateDamageDict: updateDamageDict
                             ,fetch: fetch};
};
Elm.MaybeExt = Elm.MaybeExt || {};
Elm.MaybeExt.make = function (_elm) {
   "use strict";
   _elm.MaybeExt = _elm.MaybeExt || {};
   if (_elm.MaybeExt.values) return _elm.MaybeExt.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var allOf = function (maybies) {
      var f = F2(function (mayb,list) {
         var _p0 = list;
         if (_p0.ctor === "Just") {
               var _p1 = mayb;
               if (_p1.ctor === "Just") {
                     return $Maybe.Just(A2($List._op["::"],_p1._0,_p0._0));
                  } else {
                     return $Maybe.Nothing;
                  }
            } else {
      ...
      return A3($List.foldr,f,$Maybe.Just(_U.list([])),maybies);
   };
   return _elm.MaybeExt.values = {_op: _op,allOf: allOf};
};
Elm.Pokemon = Elm.Pokemon || {};
Elm.Pokemon.make = function (_elm) {
   "use strict";
   _elm.Pokemon = _elm.Pokemon || {};
   if (_elm.Pokemon.values) return _elm.Pokemon.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $DecodeExt = Elm.DecodeExt.make(_elm),
   ...
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $MaybeExt = Elm.MaybeExt.make(_elm),
   $NamedAPIResource = Elm.NamedAPIResource.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $Type = Elm.Type.make(_elm);
   var _op = {};
   var getMissingTypes = F2(function (typeCache,pmon) {
      return A2($List.filter,
      function (ts) {
         return $Basics.not(A2($Dict.member,
         ts.typeResource.name,
         typeCache));
      },
      pmon.typeSlots);
   });
   var getMissingTypesEffect = F3(function (typeCache,
   pmon,
   callback) {
      var missingTypes = A2(getMissingTypes,typeCache,pmon);
      var effects = A2($List.map,
      function (ts) {
         return A2($Type.fetch,
         ts.typeResource.name,
         callback(ts.typeResource.name));
      },
      missingTypes);
   ...
   var viewDamagesTaken = F2(function (typeCache,tss) {
      ...
      function (t) {
         return A2($Dict.get,t.typeResource.name,typeCache);
      },
      tss));
      var _p0 = maybeTypes;
      if (_p0.ctor === "Just") {
            return $Type.viewDamageRelationsOfList(_p0._0);
         } else {
            return A2($Html.div,
            _U.list([]),
            _U.list([$Html.text("Loading type data...")]));
         }
   });
   var typeSlotToLi = function (t) {
      return A2($Html.li,
   ...
   closeCallback) {
      ...
      _U.list([A2($Html.img,
              ...
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("damageChartWrapper")]),
              _U.list([A2($Html.div,
   ...
   var typeDecoder = A3($Json$Decode.object2,
   TypeSlot,
   A2($Json$Decode._op[":="],"slot",$Json$Decode.$int),
   A2($Json$Decode._op[":="],"type",$NamedAPIResource.decoder));
   var PokemonSprites = F8(function (a,b,c,d,e,f,g,h) {
      return {back_female: a
             ,back_shiny_female: b
             ,back_default: c
             ,front_female: d
             ,front_shiny_female: e
             ,back_shiny: f
             ,front_default: g
             ,front_shiny: h};
   });
   var spritesDecoder = A9($Json$Decode.object8,
   PokemonSprites,
   A2($Json$Decode._op[":="],
   "back_female",
   $DecodeExt.nullOr($Json$Decode.string)),
   ...
   "front_shiny",
   $DecodeExt.nullOr($Json$Decode.string)));
   var Pokemon = F4(function (a,b,c,d) {
      return {id: a,name: b,sprites: c,typeSlots: d};
   });
   var decoder = A5($Json$Decode.object4,
   Pokemon,
   A2($Json$Decode._op[":="],"id",$Json$Decode.$int),
   A2($Json$Decode._op[":="],"name",$Json$Decode.string),
   A2($Json$Decode._op[":="],"sprites",spritesDecoder),
   A2($Json$Decode._op[":="],
   "types",
...
Elm.Main.make = function (_elm) {
   ...
   $PokemonTable = Elm.PokemonTable.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   ...
   var OnPokemonLoaded = F2(function (a,b) {
      return {ctor: "OnPokemonLoaded",_0: a,_1: b};
   });
   var update = F2(function (action,model) {
      ...
      {case "NoAction": return {ctor: "_Tuple2"
         ...
         case "OnPokemonTableLoaded": var _p1 = _p0._0;
           if (_p1.ctor === "Ok") {
                 return {ctor: "_Tuple2"
                        ,_0: _U.update(model,{pokemonTable: $Async.Finished(_p1._0)})
                        ,_1: $Effects.none};
              } else {
                 var _p2 = _p1._0;
                 ...
                 return {ctor: "_Tuple2"
                        ...
                        "Failed loading Pokémon: ",
                        $Basics.toString(_p2)))})
                        ,_1: $Effects.none};
              }
         case "SelectPokemon": var _p4 = _p0._0;
           var alreadySelected = function () {
              var _p3 = model.selectedPokemon;
              if (_p3.ctor === "Just") {
                    return _U.eq(_p3._0,_p4);
                 } else {
                    return false;
                 }
           }();
           return alreadySelected || A2($Dict.member,
           _p4,
           model.pokemonCache) ? {ctor: "_Tuple2"
         ...
         case "OnPokemonLoaded": var _p5 = _p0._1;
           if (_p5.ctor === "Ok") {
                 var _p6 = _p5._0;
                 var missingTypesEffects = A3($Pokemon.getMissingTypesEffect,
                 model.typeCache,
                 _p6,
                 OnTypeLoaded);
                 return {ctor: "_Tuple2"
                        ,_0: _U.update(model,
                        {pokemonCache: A3($Dict.insert,_p0._0,_p6,model.pokemonCache)})
                        ,_1: missingTypesEffects};
              } else {
                 var temp = A2($Debug.log,"Failed loading Pokémon",_p5._0);
                 return {ctor: "_Tuple2"
                        ,_0: _U.update(model,{selectedPokemon: $Maybe.Nothing})
                        ,_1: $Effects.none};
              }
         default: var _p7 = _p0._1;
           if (_p7.ctor === "Ok") {
                 return {ctor: "_Tuple2"
                        ,_0: _U.update(model,
                        {typeCache: A3($Dict.insert,_p0._0,_p7._0,model.typeCache)})
                        ,_1: $Effects.none};
              } else {
                 var temp = A2($Debug.log,"Failed loading Type",_p7._0);
                 return {ctor: "_Tuple2"
                        ,_0: _U.update(model,{selectedPokemon: $Maybe.Nothing})
                        ,_1: $Effects.none};
              }}
   ...
   var view = F2(function (address,model) {
      ...
      _U.list([function () {
              ...
              ,function () {
                 var _p10 = model.pokemonTable;
                 switch (_p10.ctor)
                 {case "NotRequested": return A2($Html.div,
                      _U.list([]),
                      _U.list([$Html.text("Nothing here :(")]));
   ...
   var init = {ctor: "_Tuple2"
              ,_0: initModel
              ,_1: $PokemonTable.fetch(OnPokemonTableLoaded)};
